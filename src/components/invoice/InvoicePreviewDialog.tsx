...
// Default invoice translations
const defaultInvoiceTranslations: Record<string, InvoiceTranslations> = {
  FR: {
  ...
  useEffect(() => {
    ...
    const calculateTableHeight = async () => {
      try {
        ...
        const { calculateTableTotalHeight } = await import('@/lib/invoicePreviewUtils');
              ...
              <div className="w-80 border-r overflow-y-auto p-4 flex-shrink-0" style={getSidebarStyle()}>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColNumberWidth', parseFloat(e.target.value) || 13.23)}
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColNumberPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColFamilyWidth', parseFloat(e.target.value) || 39.69)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColFamilyPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColModelWidth', parseFloat(e.target.value) || 39.69)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColModelPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColBrandWidth', parseFloat(e.target.value) || 31.75)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColBrandPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColQuantityWidth', parseFloat(e.target.value) || 21.17)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColQuantityPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColPriceUnitWidth', parseFloat(e.target.value) || 31.75)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColPriceUnitPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColPriceTotalWidth', parseFloat(e.target.value) || 31.75)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('invoiceColPriceTotalPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                  ...
                  <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateConfig('invoiceTableLabelLineSpacing', parseFloat(e.target.value) || 1)}
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateConfig('invoiceTableValueLineSpacing', parseFloat(e.target.value) || 1)}
                      />
                    </div>
                  </CollapsibleContent>
                </Collapsible>
                  ...
                  <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                    <div>
                      ...
                      <Input
                        ...
                        step="0.1"
                        className="h-8 text-xs"
                        value={config.invoiceClientLabelLineSpacing ?? 0.5}
                        onChange={(e) => updateConfig('invoiceClientLabelLineSpacing', parseFloat(e.target.value) || 0.5)}
                      />
                    </div>
                    <div>
                      <label className="text-xs block mb-1" style={getMutedTextColor()}>Values Line Spacing</label>
                      <Input
                        ...
                        step="0.1"
                        className="h-8 text-xs"
                        value={config.invoiceClientValueLineSpacing ?? 0.5}
                        onChange={(e) => updateConfig('invoiceClientValueLineSpacing', parseFloat(e.target.value) || 0.5)}
                      />
                    </div>
                  </CollapsibleContent>
                </Collapsible>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      updateConfig('invoiceEmptyRows', isNaN(value) ? 8 : value);
                    }}
                  />
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('invoiceSinglePageTableMaxHeight', isNaN(value) ? 297 : value);
                    }}
                  />
                  <p className="text-[10px] mt-1" style={getMutedTextColor()}>
                    Max height when invoice fits on one page
                  </p>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('invoiceLastPageTableMaxHeight', isNaN(value) ? 150 : value);
                    }}
                  />
                  <p className="text-[10px] mt-1" style={getMutedTextColor()}>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('invoiceOtherPagesTableMaxHeight', isNaN(value) ? 180 : value);
                    }}
                  />
                  <p className="text-[10px] mt-1" style={getMutedTextColor()}>
                    Max height on pages without header or footer
                  </p>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('invoiceFirstPageTableMaxHeight', isNaN(value) ? 180 : value);
                    }}
                  />
                  <p className="text-[10px] mt-1" style={getMutedTextColor()}>
...
export async function prepareInvoicePreviewData(
  order: {
    id: string;
    customerId?: string;
    customerName: string;
  ...
  try {
    ...
    let activityProfile: InvoicePreviewData['activityProfile'] | undefined = undefined;
    ...
    if (order.snapshotCustomer) {
      ...
      try {
        const customerRes = await fetch(`/api/customers/${order.customerId}`);
        if (customerRes.ok) {
          const customerData = await customerRes.json();
          customer = {
            id: customerData.id,
            fullName: customerData.fullName || order.customerName,
            shortName: customerData.shortName || order.customerName?.split(' ')[0],
            address: customerData.address || order.customerAddress,
            city: customerData.city || order.customerCity,
            phone: customerData.phone || order.customerPhone,
            email: customerData.email || order.customerEmail,
            nif: customerData.nif,
            nis: customerData.nis,
            rcn: customerData.rcn,
      ...
      // No customer ID, use basic order data
      customer = {
        id: "",
        fullName: order.customerName,
        shortName: order.customerName?.split(' ')[0],
    ...
    // Prepare machine models from order items (prefer snapshots)
    const machineModels: UtilMachineModel[] = order.items.map(item => {
      // Try to use snapshot model data
      if (item.snapshotModel) {
        try {
          const snapshotModel = JSON.parse(item.snapshotModel);
          return {
            id: snapshotModel.id || item.modelId || "",
            name: item.description || snapshotModel.name || "",
            code: snapshotModel.code,
            basePrice: item.unitPrice,
            currency: order.currency,
            isManufactured: snapshotModel.isManufactured,
            family: snapshotModel.family ? {
              id: snapshotModel.family.id,
              name: snapshotModel.family.name,
            } : undefined,
          } as UtilMachineModel;
        } catch (e) {
      ...
      return {
        id: item.modelId || "",
        name: item.description || item.model?.name || "",
        code: item.model?.code,
        basePrice: item.unitPrice,
        currency: order.currency,
        family: item.model?.family ? {
          id: item.model.family.code || "",
          name: item.model.family.name || "",
        } : undefined,
        isManufactured: item.model?.isManufactured,
      } as UtilMachineModel;
    });

    // Get logo as base64 if available
    if (company.activeLogoId && company.logos) {
      const activeLogo = company.logos.find((logo: any) => logo.isActive || logo.id === company.activeLogoId);
      if (activeLogo?.url) {
        try {
          const logoRes = await fetch(activeLogo.url);
          const blob = await logoRes.blob();
          const arrayBuffer = await blob.arrayBuffer();
          logoBase64 = `data:${blob.type};base64,${arrayBufferToBase64(arrayBuffer)}`;
        } catch (e) {
    ...
    // Generate QR code URL if verification token exists
    let qrCodeImageUrl = "";
    if (order.invoiceVerificationToken) {
      try {
        const { generateQRCodeDataURL, defaultQRCodeConfig } = await import('@/lib/qrCodeUtils');
        
        const qrData: any = {
          file: {
            type: 'Invoice',
            number: `INV-${invoiceInfo?.invoiceNumber || '0'}/${invoiceInfo?.invoiceYear || new Date().getFullYear()}`,
            date: new Date().toISOString().split('T')[0],
            totalAmount: machineModels.reduce((sum, m) => sum + (m.basePrice || 0), 0),
            currency: order.currency,
          },
          verificationToken: (order as any).verificationToken,
          company: {
            name: company.name,
        ...
        const qrConfig = {
          ...
          size: config.qrCodeSize || 100,
        };

        qrCodeImageUrl = await generateQRCodeDataURL(qrData, qrConfig);
      } catch (e) {
    ...
    return {
      ...
      customer,
      machineModels,
      selectedLanguage: order.documentLanguage?.toUpperCase() || "FR",
      selectedCurrency: order.currency,
      exchangeRates: exchangeRates as ExchangeRate[],
      logoBase64,
      invoiceNumber: invoiceInfo?.invoiceNumber,
      invoiceYear: invoiceInfo?.invoiceYear,
      qrCodeImageUrl,
      verificationToken: (order as any).verificationToken,
      activityProfile,
    };
