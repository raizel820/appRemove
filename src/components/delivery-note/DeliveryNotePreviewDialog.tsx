...
export interface DeliveryNotePreviewData {
...
// Delivery note translations type
interface DeliveryNoteTranslations {
  deliveryNoteNumber: string;
  client: string;
  noClient: string;
  address: string;
...
interface DeliveryNotePreviewDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  previewData: DeliveryNotePreviewData | null;
...
// Default delivery note translations
const defaultDeliveryNoteTranslations: Record<string, DeliveryNoteTranslations> = {
  FR: {
    deliveryNoteNumber: "Bon de Livraison N°",
    client: "Client",
  ...
  EN: {
    deliveryNoteNumber: "Delivery Note N°",
    client: "Client",
  ...
  AR: {
    deliveryNoteNumber: "إيصال تسليم رقم",
    client: "العميل",
...
export default function DeliveryNotePreviewDialog({
  open,
  onOpenChange,
  previewData,
  config,
...
}: DeliveryNotePreviewDialogProps) {
  ...
  useEffect(() => {
    ...
    const calculateTableHeight = async () => {
      try {
        ...
        const { calculateTableTotalHeight } = await import('@/lib/deliveryNotePreviewUtils');
  ...
  const getPreviewHTML = (): string => {
    ...
    return generatePreviewHTML({
      ...
      deliveryNoteTranslations: defaultDeliveryNoteTranslations,
      labelsFr: defaultLabelsFr,
      labelsAr: defaultLabelsAr,
      deliveryNoteNumber: previewData.deliveryNoteNumber,
      deliveryNoteYear: previewData.deliveryNoteYear,
              ...
              <div className="w-80 border-r overflow-y-auto p-4 flex-shrink-0" style={getSidebarStyle()}>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColNumberWidth', parseFloat(e.target.value) || 13.23)}
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColNumberPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColFamilyWidth', parseFloat(e.target.value) || 39.69)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColFamilyPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColModelWidth', parseFloat(e.target.value) || 39.69)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColModelPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColBrandWidth', parseFloat(e.target.value) || 31.75)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColBrandPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColQuantityWidth', parseFloat(e.target.value) || 21.17)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColQuantityPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColPriceUnitWidth', parseFloat(e.target.value) || 31.75)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColPriceUnitPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColPriceTotalWidth', parseFloat(e.target.value) || 31.75)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('deliveryNoteColPriceTotalPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                  ...
                  <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateConfig('deliveryNoteTableLabelLineSpacing', parseFloat(e.target.value) || 1)}
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateConfig('deliveryNoteTableValueLineSpacing', parseFloat(e.target.value) || 1)}
                      />
                    </div>
                  </CollapsibleContent>
                </Collapsible>
                  ...
                  <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                    <div>
                      ...
                      <Input
                        ...
                        step="0.1"
                        className="h-8 text-xs"
                        value={config.deliveryNoteClientLabelLineSpacing ?? 0.5}
                        onChange={(e) => updateConfig('deliveryNoteClientLabelLineSpacing', parseFloat(e.target.value) || 0.5)}
                      />
                    </div>
                    <div>
                      <label className="text-xs block mb-1" style={getMutedTextColor()}>Values Line Spacing</label>
                      <Input
                        ...
                        step="0.1"
                        className="h-8 text-xs"
                        value={config.deliveryNoteClientValueLineSpacing ?? 0.5}
                        onChange={(e) => updateConfig('deliveryNoteClientValueLineSpacing', parseFloat(e.target.value) || 0.5)}
                      />
                    </div>
                  </CollapsibleContent>
                </Collapsible>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      updateConfig('deliveryNoteEmptyRows', isNaN(value) ? 8 : value);
                    }}
                  />
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('deliveryNoteSinglePageTableMaxHeight', isNaN(value) ? 297 : value);
                    }}
                  />
                  <p className="text-[10px] mt-1" style={getMutedTextColor()}>
                    Max height when delivery note fits on one page
                  </p>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('deliveryNoteLastPageTableMaxHeight', isNaN(value) ? 150 : value);
                    }}
                  />
                  <p className="text-[10px] mt-1" style={getMutedTextColor()}>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('deliveryNoteOtherPagesTableMaxHeight', isNaN(value) ? 180 : value);
                    }}
                  />
                  <p className="text-[10px] mt-1" style={getMutedTextColor()}>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('deliveryNoteFirstPageTableMaxHeight', isNaN(value) ? 180 : value);
                    }}
                  />
                  <p className="text-[10px mt-1" style={getMutedTextColor()}>
...
export async function prepareDeliveryNotePreviewData(
  order: {
    id: string;
    customerId?: string;
    customerName: string;
...
): Promise<DeliveryNotePreviewData | null> {
  try {
    ...
    let activityProfile: DeliveryNotePreviewData['activityProfile'] | undefined = undefined;
    ...
    if (order.deliveryNoteVerificationToken && config.includeQrCode) {
      try {
        ...
        const result = await getQrCodeDataUrls(
          ...
          [customer],
          machineModels,
          order.deliveryNoteVerificationToken,
          qrCodeSettings,
          deliveryNoteInfo?.deliveryNoteNumber,
          deliveryNoteInfo?.deliveryNoteYear,
          activityProfile
        );
    ...
    return {
      ...
      deliveryNoteYear: deliveryNoteInfo?.deliveryNoteYear,
      snapshotCompany: order.snapshotCompany,
      snapshotCustomer: order.snapshotCustomer,
      snapshotPdfConfig: order.snapshotPdfConfig,
      verificationToken: order.deliveryNoteVerificationToken,
      activityProfile,
    };
  } catch (error) {
    console.error("Error preparing delivery note preview data:", error);
    return null;
  }
}
