...
// Proforma translations type
interface ProformaTranslations {
  proformaNumber: string;
  client: string;
  noClient: string;
  address: string;
...
interface ProformaPreviewDialogProps {
  ...
  previewData: ProformaPreviewData | null;
...
// Default proforma translations
const defaultProformaTranslations: Record<string, ProformaTranslations> = {
  FR: {
    proformaNumber: "Facture Proforma N°",
    client: "Client",
  ...
  EN: {
    proformaNumber: "Proforma Invoice N°",
    client: "Client",
  ...
  AR: {
    proformaNumber: "فاتورة شكلية رقم",
    client: "العميل",
...
export default function ProformaPreviewDialog({
  open,
  onOpenChange,
  previewData,
  config,
  ...
  useEffect(() => {
    ...
    const calculateTableHeight = async () => {
      try {
        ...
        const { calculateTableTotalHeight } = await import('@/lib/proformaPreviewUtils');
  ...
  const getPreviewHTML = (): string => {
    ...
    return generatePreviewHTML({
      ...
      proformaTranslations: defaultProformaTranslations,
      labelsFr: defaultLabelsFr,
      labelsAr: defaultLabelsAr,
      proformaNumber: previewData.proformaNumber,
      proformaYear: previewData.proformaYear,
              ...
              <div className="w-80 border-r overflow-y-auto p-4 flex-shrink-0" style={getSidebarStyle()}>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColNumberWidth', parseFloat(e.target.value) || 13.23)}
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColNumberPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColFamilyWidth', parseFloat(e.target.value) || 39.69)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColFamilyPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColModelWidth', parseFloat(e.target.value) || 39.69)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColModelPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColBrandWidth', parseFloat(e.target.value) || 31.75)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColBrandPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColQuantityWidth', parseFloat(e.target.value) || 21.17)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColQuantityPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColPriceUnitWidth', parseFloat(e.target.value) || 31.75)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColPriceUnitPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                    ...
                    <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColPriceTotalWidth', parseFloat(e.target.value) || 31.75)}
                        />
                      </div>
                      <div>
                        <label className="text-xs block mb-1" style={getMutedTextColor()}>Padding (mm)</label>
                        <Input
                          ...
                          onChange={(e) => updateConfig('proformaColPriceTotalPadding', parseFloat(e.target.value) || 5.61)}
                        />
                      </div>
                    </CollapsibleContent>
                  </Collapsible>
                  ...
                  <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateConfig('proformaTableLabelLineSpacing', parseFloat(e.target.value) || 1)}
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateConfig('proformaTableValueLineSpacing', parseFloat(e.target.value) || 1)}
                      />
                    </div>
                  </CollapsibleContent>
                </Collapsible>
                  ...
                  <CollapsibleContent className="space-y-1 p-2 border rounded" style={getBorderColor()}>
                    <div>
                      ...
                      <Input
                        ...
                        step="0.1"
                        className="h-8 text-xs"
                        value={config.proformaClientLabelLineSpacing ?? 0.5}
                        onChange={(e) => updateConfig('proformaClientLabelLineSpacing', parseFloat(e.target.value) || 0.5)}
                      />
                    </div>
                    <div>
                      <label className="text-xs block mb-1" style={getMutedTextColor()}>Values Line Spacing</label>
                      <Input
                        ...
                        step="0.1"
                        className="h-8 text-xs"
                        value={config.proformaClientValueLineSpacing ?? 0.5}
                        onChange={(e) => updateConfig('proformaClientValueLineSpacing', parseFloat(e.target.value) || 0.5)}
                      />
                    </div>
                  </CollapsibleContent>
                </Collapsible>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      updateConfig('proformaEmptyRows', isNaN(value) ? 8 : value);
                    }}
                  />
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('proformaSinglePageTableMaxHeight', isNaN(value) ? 297 : value);
                    }}
                  />
                  <p className="text-[10px] mt-1" style={getMutedTextColor()}>
                    Max height when proforma fits on one page
                  </p>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('proformaLastPageTableMaxHeight', isNaN(value) ? 150 : value);
                    }}
                  />
                  <p className="text-[10px] mt-1" style={getMutedTextColor()}>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('proformaOtherPagesTableMaxHeight', isNaN(value) ? 180 : value);
                    }}
                  />
                  <p className="text-[10px] mt-1" style={getMutedTextColor()}>
                ...
                <div className="mb-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const value = parseInt(e.target.value);
                      updateConfig('proformaFirstPageTableMaxHeight', isNaN(value) ? 180 : value);
                    }}
                  />
                  <p className="text-[10px mt-1" style={getMutedTextColor()}>
...
export async function prepareProformaPreviewData(
  order: {
    id: string;
    customerId?: string;
    customerName: string;
...
): Promise<ProformaPreviewData | null> {
  try {
    ...
    let activityProfile: ProformaPreviewData['activityProfile'] | undefined = undefined;
    ...
    if (order.proformaVerificationToken && config.includeQrCode) {
      try {
        ...
        const result = await getQrCodeDataUrls(
          ...
          [customer],
          machineModels,
          order.proformaVerificationToken,
          qrCodeSettings,
          proformaInfo?.proformaNumber,
          proformaInfo?.proformaYear,
          activityProfile
        );
    ...
    return {
      ...
      proformaYear: proformaInfo?.proformaYear,
      activityProfile,
      snapshotCompany: order.snapshotCompany,
      snapshotCustomer: order.snapshotCustomer,
      snapshotPdfConfig: order.snapshotPdfConfig,
      verificationToken: order.proformaVerificationToken,
    };
  } catch (error) {
    console.error("Error preparing proforma preview data:", error);
    return null;
  }
}
